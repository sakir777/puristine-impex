        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 pb-16 border-b border-white/10">
          ...
          <div>
            ...
            <div class="flex gap-4">
              ...
              <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#ED835E] hover:text-[#44749E] transition-all" aria-label="Instagram">
